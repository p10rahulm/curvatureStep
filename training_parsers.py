...
parse_training_logs('outputs/fmnist_training_run_logs11.txt', 'FashionMNIST')
...
parse_training_logs('outputs/reuters_training_run_logs11.txt', 'reuters-large-batch')
parse_training_logs('outputs/sogou_training_run_logs1.txt', 'sogou-news')
