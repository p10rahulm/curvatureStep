...
from models.simpleCNN_template import SimpleCNN  # Change to the SimpleCNN model
...
for optimizer_class, default_params in optimizers:
    print(f"\nRunning Caltech101 training with Optimizer = {str(optimizer_class.__name__)}")
...
write_to_file('outputs/caltech101_training_logs.csv', results)
