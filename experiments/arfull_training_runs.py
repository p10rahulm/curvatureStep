# experiments/amazon_reviews_full_training_runs.py
...
from data_loaders.arfull import load_dataset, vocab_size, pad_idx
...
def main():
    ...
    print("#", "-"*100)
    print("# Running Amazon Reviews Full Training Experiment")
    print("#", "-"*100)
    ...
    model_hyperparams = {
        ...
        'embed_dim': 100,
        'hidden_dim': 256,
        'output_dim': 5,  # 5 classes for Amazon Reviews Full
        'pad_idx': pad_idx,
    }
    ...
    dataset_config = {
        ...
        'num_epochs': 5,       # 10 epochs as per your original script
