# experiments/dbpedia_training_runs.py
...
from data_loaders.dbpedia import load_dbpedia, vocab_size, pad_idx
...
def modify_optimizer_params(optimizers):
    ...
    modified_optimizers = []
    curvature_optimizers = ["HeavyBallCurvature", "NAGCurvature"]
...
def main():
    ...
    print("#", "-"*100)
    print("# Running DBpedia Training Experiment")
    print("#", "-"*100)
    ...
    model_hyperparams = {
        ...
        'embed_dim': 100,
        'hidden_dim': 256,
        'output_dim': 14,        # DBpedia has 14 classes
        'pad_idx': pad_idx,
    }
