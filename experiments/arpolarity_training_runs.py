# experiments/amazon_reviews_polarity_training_runs.py
...
from data_loaders.arpolarity import load_dataset, vocab_size, pad_idx
...
def main():
    ...
    print("#", "-"*100)
    print("# Running Amazon Reviews Polarity Training Experiment")
    print("#", "-"*100)
    ...
    model_hyperparams = {
        ...
        'embed_dim': 100,
        'hidden_dim': 256,
        'output_dim': 2,  # Changed to 2 for binary polarity classification
        'pad_idx': pad_idx,
    }

    # Dataset-specific configuration
    dataset_config = {
        'dataset_name': 'arpolarity',
        'train_fn': train_lm,
