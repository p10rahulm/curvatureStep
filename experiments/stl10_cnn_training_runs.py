# experiments/stl10_training_runs.py
...
from data_loaders.stl10_cnn import load_stl10
import torch
...
for optimizer_class, default_params in optimizers:
    print(f"\nRunning STL10 training with Optimizer = {str(optimizer_class.__name__)}")
...
write_to_file('outputs/stl10_training_logs.csv', results)
