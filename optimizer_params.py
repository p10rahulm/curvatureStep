...
optimizers = [
    (SimpleSGD, {'lr': 1e-3}),
    (SimpleSGDCurvature, {'lr': 1e-3, 'momentum_mult': 0.9, 'epsilon': 0.01}),
    (Adam, {'lr': 1e-3, 'betas': (0.9, 0.999)}),
    (AdamCurvature, {'lr': 1e-3, 'betas': (0.9, 0.999), 'epsilon': 0.01}),
    (HeavyBall, {'lr': 1e-3, 'momentum': 0.9}),
    (HeavyBallCurvature, {'lr': 1e-3, 'momentum': 0.1, 'epsilon': 0.01}),
    (NAG, {'lr': 1e-3, 'momentum': 0.9}),
    (NAGCurvature, {'lr': 1e-3, 'momentum': 0.9, 'epsilon': 0.01}),
    ...
    (RMSProp, {'lr': 1e-2, 'alpha': 0.99, 'eps': 1e-8, 'weight_decay': 0}),
    (RMSPropCurvature, {'lr': 1e-2, 'alpha': 0.99, 'eps': 1e-8, 'weight_decay': 0, 'epsilon': 0.01}),
    (RMSPropMomentum, {'lr': 1e-2, 'alpha': 0.99, 'eps': 1e-8, 'weight_decay': 0, 'momentum': 0.1}),
