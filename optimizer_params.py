...
optimizers = [
    ...
    # (AdagradCurvature, {'lr': 1e-2, 'eps': 1e-6, 'epsilon': 0.01}),
    (Adadelta, {'lr': 1e-3, 'rho': 0.95, 'eps': 1e-6}),
    # (AdadeltaCurvature, {'lr': 1.0, 'rho': 0.6, 'eps': 1e-6, 'epsilon': 0.01}),
    (RMSProp, {'lr': 1e-3, 'alpha': 0.9, 'eps': 1e-6, 'weight_decay': 0}),
    # (RMSPropCurvature, {'lr': 1e-2, 'alpha': 0.99, 'eps': 1e-6, 'weight_decay': 0, 'epsilon': 0.01}),
    (RMSPropMomentum, {'lr': 1e-3, 'alpha': 0.9, 'eps': 1e-6, 'weight_decay': 0, 'momentum': 0.05}),
    # (RMSPropMomentumCurvature, {'lr': 1e-2, 'alpha': 0.99, 'eps': 1e-6, 'weight_decay': 0, 'momentum': 0.1, 'epsilon': 0.01}),
